...
# Source: https://github.com/ArdalanM/nlp-benchmarks/blob/master/src/vdcnn/net.py
...
class VDCNNClassifier(nn.Module):
    ...
    def __init__(self, vocab_size, num_classes=6, hidden_size=768, depth=9, n_fc_neurons=2048, shortcut=False):
        super(VDCNNClassifier, self).__init__()
        ...
        fc_layers.extend([nn.Linear(n_fc_neurons, num_classes)])
