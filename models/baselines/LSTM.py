...
# Source: https://github.com/prakashpandey9/Text-Classification-Pytorch/blob/master/models/LSTM.py
import torch
...
class LSTMClassifier(nn.Module):
	...
	def forward(self, input_ids, attention_mask=None, batch_size=None):
